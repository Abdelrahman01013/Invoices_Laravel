        ...
        <ul class="side-menu">
            ...
            <li class="slide">
                <a class="side-menu__item" href="{{ url('/dashboard') }}"><svg xmlns="http://www.w3.org/2000/svg"
                    ...
                    </svg><span class="side-menu__label">الصفحه الرئيسه</span></a>
            </li>
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        ...
                        @can('الفواتير المدفوعة')
                            <li><a class="slide-item" href="{{ route('show_invoices_status', ['id' => 1]) }}">الفواتير
                                    المدفوعه</a>
                            </li>
                        @endcan
                        @can('الفواتير الغير مدفوعة')
                            <li><a class="slide-item" href="{{ route('show_invoices_status', ['id' => 2]) }}">الفواتير الغير
                                    مدفوعه</a></li>
                        @endcan
                        @can('الفواتير المدفوعة جزئيا')
                            <li><a class="slide-item" href="{{ route('show_invoices_status', ['id' => 3]) }}">الفواتير المدفوعه
                                    جزئيا</a>
                            </li>
                        @endcan
                        @can('ارشيف الفواتير')
                            <li><a class="slide-item" href="{{ route('Archive.index') }}"> الأرشيف</a>
                            </li>
                        @endcan
            ...
            @can('التقارير')
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        @can('تقرير الفواتير')
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'invouce_report')) }}">تقارير الفواتير </a>
                            </li>
                        @endcan
                        @can('تقرير العملاء')
                            <li><a class="slide-item" href="{{ route('customer_search') }}">تقارير العملاء</a>
                            </li>
                        @endcan
