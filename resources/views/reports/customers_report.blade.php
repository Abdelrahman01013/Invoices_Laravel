    ...
    <div class="col-xl-12">
        <div class="card mg-b-20">
            ...
            <div class="card-header pb-0">
                ...
                <form action="{{ url('Customer') }}" method="GET" role="search" autocomplete="off">
                    {{ csrf_field() }}
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <select name="Section" class="form-control SlectBox" id="sectionSelect">
                                <!--placeholder-->
                        ...
                        <div class="col">
                            ...
                            <select id="product" name="product" class="form-control">
                                <option value="كل الاقسام"> حدد المنتج</option>
                            </select>
                        </div>
                            ...
                            <tbody>
                                ...
                                @foreach ($details as $invoice)
                                    <tr>
                                        ...
                                        <td>
                                        <td> <a href="{{ route('detalis.edit', $invoice->id) }}">
...
<script>
    $(document).ready(function() {
        $('#sectionSelect').change(function() {
            ...
            if (sectionId) {
                $.ajax({
                    url: '{{ route('getProductsBySection') }}',
                    type: 'POST',
                    data: {
